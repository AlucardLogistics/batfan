<?php
	...
	function change_profile_image($user_id, $file_temp, $file_extn) {
		...
		$file_path = '../public/images/profile/' . substr(md5(time()), 0, 10) . '.' . $file_extn;
	...
	function update_user($user_id, $update_data) {
		$update = array();
		array_walk($update_data, 'array_sanitize'); //array_sanitize - sanitize elements in an array - function in general.php
	...
	function register_user($register_data) {
		array_walk($register_data, 'array_sanitize'); //array_sanitize - sanitize elements in an array - function in general.php
		...
		\n
		Click the link below to activate your ossom account:
		\n
		http://localhost/batman/public/activate.php?email=" . $register_data['email'] . "&email_code=" . $register_data['email_code'] .  "
		\n \n
		-BatzCave
		");
